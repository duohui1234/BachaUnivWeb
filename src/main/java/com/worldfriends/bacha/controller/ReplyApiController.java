...
public class ReplyApiController {
	...
	public Reply get(@PathVariable int boardId, 
					 @PathVariable int replyId) throws Exception{
		return service.getReply(replyId);
	}
	
	@RequestMapping(method=RequestMethod.POST)
	public Reply insert(@PathVariable int boardId,
	...
	public Reply update(@PathVariable int boardId,
					    @RequestBody Reply reply) throws Exception{

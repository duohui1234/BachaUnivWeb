...
public interface BoardService {
    ...
    List<Attachment> getAttachments(int boardId) throws Exception;
    //boolean insertAttachment(Attachment attachmenet) throws Exception;
    boolean deleteAttachment(int attachmentId) throws Exception;
    //boolean deleteByBoardId(int boardId) throws Exception;

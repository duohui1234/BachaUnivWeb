...
public class S3Util {
	...
	private String accessKey = "AKIAIM4SLNIXNRMHVFZQ"; // 엑세스 키
	private String secretKey = "+Q914JcXdngF/P3Z4vp5C7MheLTWu27XT/lXzjSr"; // 보안 엑세스 키
	...
	public S3Util() {
		...
		//this.conn = new AmazonS3ClientBuilder(credentials, clientConfig);

	...
	<div class="row">
		...
		<c:forEach var="alumnus" items="${list}">
			...
			<div class="col-lg-4 col-md-6 mb-10"
				...
				<p class=" blue-text">
					<strong>${alumnus.major} / ${alumnus.studentNumber}</strong>
				</p>
				<p class="grey-text">
				...
				<p class="">${alumnus.introduction}</p>

				<div class="contact_icon">

					<!--email -->
					<a class="p-2 fa-sm" href="contact_form?email=${alumnus.email}">
						<i class="fa fa-envelope"></i>
					</a>

					<!-- Facebook-->
					<a class="p-2 fa-lg" href=""> <i class="fa fa-facebook ">
					</i>
					</a>
					<!-- Twitter -->
					<a class="p-2 fa-lg" href=""> <i class="fa fa-twitter"> </i>
					</a>
					<!--instagram -->
					<a class="p-2 fa-lg" href=""> <i class="fa fa-instagram"></i>
					</a>
				</div>
			</div>
			<!-- Grid column -->

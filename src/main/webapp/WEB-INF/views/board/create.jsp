...
<script>
	...
	$(document).ready(
			function() {
				...
				$('.filebox label[for="files"]').mouseover(function() {
					$('.filebox label[for="files"]').removeClass('font-color');
					$('.filebox label[for="files"]').addClass('upload');
				});
...
<div class="py-5">
	<div class="container col-lg-9 col-md-10 col-sm-11 mx-auto">
		...
		<form:form commandName="board" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<label for="writerName"><span class="title">WRITER :
				</span>${USER.studentName} (${USER.studentNumber})</label>
			</div>
			...
			<div class="mt-4 filebox row">
				<div class="col-md-3">
					<label for="files" class="font-color"><i
						class="fa fa-paperclip title"></i> FILE UPLOAD</label> <input type="file"
						name="files" id="files" multiple="multiple">
				</div>

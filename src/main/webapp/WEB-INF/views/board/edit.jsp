...
<div class="py-5">
	<div class="container col-lg-9 col-md-10 col-sm-11 mx-auto">
		...
		<form:form commandName="board" enctype="multipart/form-data">
			...
			<div class="mb-5">
				<label for="writer"><span class="title">WRITER :</span>
					${board.writer}</label>
			...
			<div class=" filebox mb-4 row">
				...
				<div class="col-md-3">
					<label for="files" class="font-color">FILE UPLOAD</label> <input
				...
				<div class="col-md-9">
					...
					<div id="fileList">
						<c:forEach var="file" items="${board.attachments}">
							<p id="file">
								${file.fileName} <a href="#" class="attachment trash"
									data-target="${file.attachmentId}">&nbsp;<i
									class="fa fa-times text-danger align-middle"></i></a>
							</p>
						</c:forEach>
					</div>
				</div>

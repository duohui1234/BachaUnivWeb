...
<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
   ...
   <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
         <img class="d-block w-100" src="resources/images/header1.jpg" alt="First slide">
      ...
      <div class="carousel-item">
         <img class="d-block w-100" src="resources/images/header2.jpg" alt="Second slide">
      ...
      <!--Third slide-->
      <div class="carousel-item">
         <img class="d-block w-100" src="resources/images/header3.jpg" alt="Third slide">
...
<div class="container">
    <!--Section: More-->
      <section>
        <h2 class="my-5 h3 text-center mt-20">...and even more</h2>

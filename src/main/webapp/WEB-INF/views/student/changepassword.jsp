...
<div class="py-5">
	<div id="edit-form"
		class="edit-form container mx-auto col-lg-6 col-md-8 col-sm-10">
		<h4
			style="margin-bottom: 50px !important; padding-bottom: 20px !important; border-bottom: 1px dotted #8c8b8b;">Change
			Password</h4>
		...
		<form:form commandName="password" id="change-form">
			...
			<div class="md-form">
				<label for="newPassword2">New Password</label> <input
					type="password" name="newPassword2" id="newPassword2"
					class="form-control" required /> <span id="check-pw-message"></span>
			</div>

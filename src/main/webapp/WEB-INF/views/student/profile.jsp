...
<div class="py-5 container">
	...
	<div class="row col-11 mx-auto justify-content-center">
		...
		<h4 class="col-lg-11 col-md-12 col-sm-12 mx-auto"
			style="margin-bottom: 50px !important; padding-bottom: 20px !important; border-bottom: 1px dotted #8c8b8b;">Student
			Info</h4>
	...
	<div class="row col-sm-12 form-group justify-content-center"
		style="padding-top: 50px !important">
		<a href="${root}student/changepassword" class="btn"
			style="background-color: #ee3733;"><i class="fa fa-lock"></i> Change
			password</a> <a href="${root}student/edit" class="btn"
			style="background-color: #ee3733;"><i class="fa fa-edit"></i> Edit
			Info</a>
	</div>
